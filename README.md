...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=200&section=header&text=Mahdi%20Chouchen&fontSize=60&fontColor=fff&animation=twinkling&fontAlignY=35&desc=AI%20Engineer%20%7C%20ML%20%7C%20Data%20Science&descAlignY=55&descSize=18" width="100%"/>

<!-- Typing Animation -->
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=6AD3F7&center=true&vCenter=true&random=false&width=600&height=60&lines=AI+Engineer+%F0%9F%A4%96;NVIDIA+Platinum+Instructor+%F0%9F%8F%86;Machine+Learning+%26+Deep+Learning;NLP+%7C+Computer+Vision+%7C+LLMs;Building+the+Future+with+AI+%F0%9F%9A%80" alt="Typing SVG" />
</a>
...
class MahdiChouchen:
    def __init__(self):
        self.name       = "Mahdi Chouchen"
        self.role       = "AI Engineer"
        self.location   = "Sousse, Tunisia 🇹🇳"
        self.education  = "EPI – International Multidisciplinary School (2022–2027)"
        self.passion    = "Transforming ideas into reality through AI & Data Science"
        self.community  = "NVIDIA Platinum Instructor & Ambassador 🏆"

    def current_focus(self):
        return [
            "🔭 Building AI-powered solutions for real-world impact",
            "🌱 Mastering LLMs, RAG pipelines & Agentic AI",
            "👨‍🏫 Teaching AI at NVIDIA – Shaping the next generation",
            "📝 Publishing peer-reviewed research (Springer Nature)",
            "⚡ Improving Road Safety in Tunisia with AI"
        ]
...
|:---|:---|:---|
| 🟢 Building Transformer-Based NLP Applications | **NVIDIA** | 2026 |
...
| ⭐ Platinum Instructor Status | **NVIDIA Ambassador Program** | – |
...
> 🛣️ **AI Road Safety Tunisia** — Leveraging Computer Vision & Deep Learning to reduce road accidents in Tunisia  
> 🌐 **Event Platform** — Full-stack web application built with modern frameworks  
> 📄 **Peer Reviewer** — Contributing to scientific advancement via Springer Nature publications  
